  ...
  initOptions = () => {
    ...
    if(housingInfo) {
        ...
        pieChart.setOption({
            ...
            color: ['#d7000e','#df4900', '#ffef00', '#2e9f23', '#0055aa'],
            ...
            series: [
                {
                    ...
                    // },
                        ...
                        // vehicleRecords: 
                    data: [
                        {value: housingInfo.vehicleRecords, name:'过车感知'},
                        {value: housingInfo.personnelRecord, name:'开门记录'},
                        {value: housingInfo.faceTotal, name:'人脸抓拍'},
                        {value: housingInfo.perceptions, name:'事件感知'},
                        {value: housingInfo.mac, name:'MAC感知'},
                    ]                  
                }
            ],
        })
