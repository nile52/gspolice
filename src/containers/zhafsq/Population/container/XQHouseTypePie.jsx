  ...
  initOptions = () => {
    ...
    if(housingInfo) {
        ...
        pieChart.setOption({
            ...
            color: [ '#2e9f23','#ffef00', '#5b5b5b', '#0055aa','#d7000e','#df4900' ],
            ...
            series: [
                {
                    ...
                    // },
                    data: [
                        // {value: housingInfo.total, name:'实有人口'},
                        {value: housingInfo.permanentTotal, name:'常住人口'},
                        // {value:housingInfo.residenceTotal, name:'居住证数'},
                        {value:housingInfo.flowTotal, name:'流动人口'},
                        {value:housingInfo.total - housingInfo.permanentTotal - housingInfo.flowTotal, name:'其他'},
