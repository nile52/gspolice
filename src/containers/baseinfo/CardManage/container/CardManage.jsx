...
import * as actions from '../actions/CardManage'
import '../style/CardManage.less'
...
class CardManage extends Component {
  ...
  render() {
    let url = this.props.CardManage.url
    // 车辆管理
    let url1 = `http://${url}/hrms/#!/person-manager?userId=1&fromC=1&isThird=true&token=`
    return (
      <div>
        <BreadCrumbCustom first="基本信息管理" second="卡信息管理"/>
        <Row gutter={16}>
